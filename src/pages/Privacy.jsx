...
export default function Privacy() {
  return (
    <>
      <SEO title="Privacy Policy" description="Privacy policy for Tampa Pro Services." />
      <div className="max-w-3xl mx-auto px-4 py-14">
        ...
        <div className="prose prose-gray max-w-none text-sm leading-relaxed space-y-4 text-gray-600">
          ...
          <p>Tampa Pro Services ("we", "us", "our") collects information you provide through our contact form — including your name, email, phone number, and project details — solely to respond to your service inquiries.</p>
          ...
          <p>Questions about this policy? Email us at info@tampapro.com.</p>
        </div>
      </div>
    </>
  )
