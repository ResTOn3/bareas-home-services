...
export default function Terms() {
  return (
    <>
      <SEO title="Terms of Service" description="Terms of service for Tampa Pro Services." />
      <div className="max-w-3xl mx-auto px-4 py-14">
        ...
        <div className="text-sm leading-relaxed space-y-4 text-gray-600">
          ...
          <p>By using this website, you agree to these terms. Tampa Pro Services provides this website for informational purposes to connect potential clients with our services.</p>
          ...
          <p>Tampa Pro Services is not liable for damages arising from the use of this website. Content is provided "as is" without warranties.</p>
          <h2 className="text-base font-bold text-brand-navy mt-6">Contact</h2>
          <p>Questions? Reach us at info@tampapro.com or (813) 555-0100.</p>
        </div>
      </div>
    </>
  )
