...
const fallback = [
  ...
  { id: '3', client_name: 'Carmen Díaz', service: 'Electrical', review: 'Actualizaron el panel eléctrico rápido y al precio cotizado. Muy profesionales y hablan español.', rating: 5, location: 'Clearwater, FL' },
  ...
  { id: '5', client_name: 'Ana Martínez', service: 'Remodeling', review: 'Remodelamos la cocina completa. Quedó hermosa y el equipo fue siempre puntual y ordenado.', rating: 5, location: 'Tampa, FL' },
...
export default function Testimonials() {
  ...
  return (
    <>
      <SEO
        title="Client Reviews — Tampa Pro Services"
